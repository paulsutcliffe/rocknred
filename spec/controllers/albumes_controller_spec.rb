...
describe AlbumesController do
  ...
  # AlbumesController. Be sure to keep this updated too.
  def valid_session
    {}
  end

  describe "GET index" do
    it "assigns all albumes as @albumes" do
      album = Album.create! valid_attributes
      get :index, {}, valid_session
      assigns(:albumes).should eq([album])
    end
  end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested album" do
        album = Album.create! valid_attributes
        # Assuming there are no other albumes in the database, this
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the albumes list" do
      album = Album.create! valid_attributes
      delete :destroy, {:id => album.to_param}, valid_session
      response.should redirect_to(albumes_url)
    end
  end
